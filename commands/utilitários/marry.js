...
module.exports = {
    ...
    run: async (client, message, args) => {
		...
		let bot = new discord.MessageEmbed()
			.setColor('ffffff')
			.setDescription('Você não pode se casar comigo bobinho.')
			...
			.setTimestamp();
				...
				.setDescription(`Infelizmente você não pode casar com sigo mesmo`)
				.setColor('ffffff')
				...
				.setDescription(`Infelizmente você não pode casar se casar com um bot`)
				.setColor('ffffff')
