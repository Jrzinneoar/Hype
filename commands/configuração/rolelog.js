...
if(l1 == null) l1 = '\`Nenhum canal setado\`'
    ...
    .setColor('ffffff')
    .setDescription(` Configure nosso canal de log abaixo!\n\n<a:1_:1132093814278983800> Canal de log : ${msglog}\n<a:2_:1132093884705558628> Sistema de cargo criado : ${msglogedit}\n<a:3_:1132093954070945934>  Sistema de cargo deletado : ${msglogdel}\n<a:4_:1132094036753260544> Salvar configuração`)    .setFooter(`${message.guild.name}`,message.guild.iconURL({ dynamic: true, format: "png", size: 1024 }))
   .setTimestamp();
...
case 'butao2':
   ...
   if(msglogedit === 'Desligado'){
    ...
    .setDescription(` Hey, ${message.member} Você precisa setar o canal de role log `)
    .setColor('ffffff')
    .setFooter(`${message.guild.name}`,message.guild.iconURL({ dynamic: true, format: "png", size: 1024 }))
    .setTimestamp();
  if(msglog == '\`Nenhum canal setado\`') return message.channel.send({embeds:[dadsad]}).then(msg=>  setTimeout(()=>{msg.delete()},4000))
    ...
    .setDescription(`Sistema de cargo criado **habilitado.**`)
    .setColor('ffffff')
    ...
    .setDescription(` Sistema de cargo criado **desabilitado.**`)
    .setColor('ffffff')
    ...
    .setTimestamp();
      ...
      case 'butao3':
        ...
        .setDescription(`Sistema de cargo deletado **habilitado.**`)
        .setColor('ffffff')
        ...
        .setDescription(` Sistema de cargo deletado **desabilitado.**`)
        .setColor('ffffff')
