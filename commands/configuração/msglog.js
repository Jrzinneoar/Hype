...
switch (r.customId) {
 ...
 case 'butao2':
  ...
  if(msglogedit === 'Desligado'){
    ...
    .setDescription(`Hey, ${message.member} Você precisa setar o canal de msg log `)
    .setColor('ffffff')
    .setFooter(`${message.guild.name}`,message.guild.iconURL({ dynamic: true, format: "png", size: 1024 }))
    .setTimestamp();
  ...
  let dadasdsadasda = new Discord.MessageEmbed()
    ...
    .setDescription(` Sistema de mensagem editada **habilitado.**`)
    .setColor('ffffff')
  ...
  let dadasdsadasda = new Discord.MessageEmbed()
    ...
    .setDescription(`Sistema de mensagem editada **desabilitado.**`)
    .setColor('ffffff')
  ...
  let dadasdsradasda = new Discord.MessageEmbed()
    ...
    .setDescription(`Sistema de mensagem deletada **habilitado.**`)
    .setColor('ffffff')
  ...
  let dadasdsadasda = new Discord.MessageEmbed()
    ...
    .setDescription(`Sistema de mensagem deletada **desabilitado.**`)
    .setColor('ffffff')
