...
case 'butao2':
  ...
  .setDescription(`Hey, ${message.member} Você precisa setar o canal de channel log `)
  .setColor('ffffff')
  .setFooter(`${message.guild.name}`,message.guild.iconURL({ dynamic: true, format: "png", size: 1024 }))
  .setTimestamp();
  ...
  .setDescription(`Sistema de canal criado **habilitado.**`)
  .setColor('ffffff')
  ...
  .setDescription(`Sistema de canal criado **desabilitado.**`)
  .setColor('ffffff')
 ...
 .setDescription(`Sistema de canal deletado **habilitado.**`)
 .setColor('ffffff')
 ...
 .setDescription(`Sistema de canal deletado **desabilitado.**`)
 .setColor('ffffff')
