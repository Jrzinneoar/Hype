...
if(l1 == null) l1 = '\`Nenhum canal setado\`'
  ...
  let antipri= db.get(`antikickpriv_${message.guild.id}`)
    ...
    .setColor('ffffff')
    .setDescription(`Configure nosso sistema de kick abaixo!\n\n<a:1_:1132093814278983800> Canal de log : ${msglog}\n<a:2_:1132093884705558628> Sistema de membro expulso : ${msglogdel}\n<a:3_:1132093954070945934> Sistema anti privatização de expulsão : ${antipri}\n<a:4_:1132094036753260544> Bloquear expulsões por outros bots: ${bloqbot}\n<a:5_:1132094083733672017> Salvar configuração`)
    .setFooter(`${message.guild.name}`,message.guild.iconURL({ dynamic: true, format: "png", size: 1024 }))
    .setTimestamp()
...
case 'butao2':
  ...
  if(msglogdel === 'Desligado'){
    ...
    .setDescription(`Hey, ${message.member} Você precisa setar o canal de expulsão log `)
    .setColor('ffffff')
    .setFooter(`${message.guild.name}`,message.guild.iconURL({ dynamic: true, format: "png", size: 1024 }))
    .setTimestamp();
  ...
  let dadasdsadasda = new Discord.MessageEmbed()
    ...
    .setDescription(`Sistema de membro expulso **habilitado.**`)
    .setColor('ffffff')
 ...
 msglogdel = 'Ligado'
  ...
  let dadasdsadasda = new Discord.MessageEmbed()
    ...
    .setDescription(`Sistema de membro expulso **desabilitado.**`)
    .setColor('ffffff')
...
break;
  ...
  let dadasdsradasda = new Discord.MessageEmbed()
    ...
    .setDescription(`Sistema de anti privatização de kick **habilitado.**`)
    .setColor('ffffff')
 ...
 r.message.edit({embeds:[embed32b1]})
  ...
  let dadasdsadasda = new Discord.MessageEmbed()
    ...
    .setDescription(` Sistema de anti privatização de kick **desabilitado.**`)
    .setColor('ffffff')
...
if(antipri === 'Desligado'){
  let dadsad = new Discord.MessageEmbed()
  .setDescription(`Hey, ${message.member} Você precisa habilitar a opção de anti privatização de kick para utilizar essa opção`)
  .setColor('ffffff')
  .setFooter(`${message.guild.name}`,message.guild.iconURL({ dynamic: true, format: "png", size: 1024 }))
  .setTimestamp();
  ...
  let dadasdsradasda = new Discord.MessageEmbed()
    ...
    .setDescription(` Sistema de bloquear expulsão por outros bot **habilitado.**`)
    .setColor('ffffff')
 ...
 r.message.edit({embeds:[embed32b1]})
  ...
  let dadasdsadasda = new Discord.MessageEmbed()
    ...
    .setDescription(`Sistema de bloquear expulsão por outros bot **desabilitado.**`)
    .setColor('ffffff')
